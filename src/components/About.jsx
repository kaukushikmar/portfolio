      ...
      <div className="flex gap-6 justify-between items-center max-md:flex-wrap max-xl:justify-center">
        <div className="w-1/2 max-xl:w-full text-left max-md:text-center">
          ...
          <p className="text-3xl max-md:text-base mb-5 font-light">
            I'm a Full-stack Developer, I am passionate about creating seamless,
            beautiful, and creative websites. With experience in various
            programming languages and web technologies, I bring ideas to life
            through code.
          </p>
          <a
            href="#contact"
